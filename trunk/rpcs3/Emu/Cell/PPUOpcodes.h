...
public:
	...
	START_OPCODES_GROUP(G_04)
		ADD_OPCODE(MFVSCR,(OP_REG vrd));
		ADD_OPCODE(MTVSCR,(OP_REG vrb));
		ADD_OPCODE(VADDCUW,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VADDFP,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VADDSBS,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VADDSHS,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VADDSWS,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VADDUBM,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VADDUBS,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VADDUHM,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VADDUHS,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VADDUWM,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VADDUWS,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VAND,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VANDC,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VAVGSB,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VAVGSH,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VAVGSW,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VAVGUB,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VAVGUH,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VAVGUW,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VCFSX,(OP_REG vrd, OP_uIMM uimm5, OP_REG vrb));
		ADD_OPCODE(VCFUX,(OP_REG vrd, OP_uIMM uimm5, OP_REG vrb));
		ADD_OPCODE(VCMPBFP,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VCMPBFP_,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VCMPEQFP,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VCMPEQFP_,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VCMPEQUB,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VCMPEQUB_,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VCMPEQUH,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VCMPEQUH_,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VCMPEQUW,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VCMPEQUW_,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VCMPGEFP,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VCMPGEFP_,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VCMPGTFP,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VCMPGTFP_,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VCMPGTSB,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VCMPGTSB_,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VCMPGTSH,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VCMPGTSH_,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VCMPGTSW,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VCMPGTSW_,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VCMPGTUB,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VCMPGTUB_,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VCMPGTUH,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VCMPGTUH_,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VCMPGTUW,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VCMPGTUW_,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VCTSXS,(OP_REG vrd, OP_uIMM uimm5, OP_REG vrb));
		ADD_OPCODE(VCTUXS,(OP_REG vrd, OP_uIMM uimm5, OP_REG vrb));
		ADD_OPCODE(VEXPTEFP,(OP_REG vrd, OP_REG vrb));
		ADD_OPCODE(VLOGEFP,(OP_REG vrd, OP_REG vrb));
		ADD_OPCODE(VMADDFP,(OP_REG vrd, OP_REG vra, OP_REG vrb, OP_REG vrc));
		ADD_OPCODE(VMAXFP,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VMAXSB,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VMAXSH,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VMAXSW,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VMAXUB,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VMAXUH,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VMAXUW,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VMHADDSHS,(OP_REG vrd, OP_REG vra, OP_REG vrb, OP_REG vrc));
		ADD_OPCODE(VMHRADDSHS,(OP_REG vrd, OP_REG vra, OP_REG vrb, OP_REG vrc));
		ADD_OPCODE(VMINFP,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VMINSB,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VMINSH,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VMINSW,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VMINUB,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VMINUH,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VMINUW,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VMLADDUHM,(OP_REG vrd, OP_REG vra, OP_REG vrb, OP_REG vrc));
		ADD_OPCODE(VMRGHB,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VMRGHH,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VMRGHW,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VMRGLB,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VMRGLH,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VMRGLW,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VMSUMMBM,(OP_REG vrd, OP_REG vra, OP_REG vrb, OP_REG vrc));
		ADD_OPCODE(VMSUMSHM,(OP_REG vrd, OP_REG vra, OP_REG vrb, OP_REG vrc));
		ADD_OPCODE(VMSUMSHS,(OP_REG vrd, OP_REG vra, OP_REG vrb, OP_REG vrc));
		ADD_OPCODE(VMSUMUBM,(OP_REG vrd, OP_REG vra, OP_REG vrb, OP_REG vrc));
		ADD_OPCODE(VMSUMUHM,(OP_REG vrd, OP_REG vra, OP_REG vrb, OP_REG vrc));
		ADD_OPCODE(VMSUMUHS,(OP_REG vrd, OP_REG vra, OP_REG vrb, OP_REG vrc));
		ADD_OPCODE(VMULESB,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VMULESH,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VMULEUB,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VMULEUH,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VMULOSB,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VMULOSH,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VMULOUB,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VMULOUH,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VNMSUBFP,(OP_REG vrd, OP_REG vra, OP_REG vrb, OP_REG vrc));
		ADD_OPCODE(VNOR,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VOR,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VPERM,(OP_REG vrd, OP_REG vra, OP_REG vrb, OP_REG vrc));
		ADD_OPCODE(VPKPX,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VPKSHSS,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VPKSHUS,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VPKSWSS,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VPKSWUS,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VPKUHUM,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VPKUHUS,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VPKUWUM,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VPKUWUS,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VREFP,(OP_REG vrd, OP_REG vrb));
		ADD_OPCODE(VRFIM,(OP_REG vrd, OP_REG vrb));
		ADD_OPCODE(VRFIN,(OP_REG vrd, OP_REG vrb));
		ADD_OPCODE(VRFIP,(OP_REG vrd, OP_REG vrb));
		ADD_OPCODE(VRFIZ,(OP_REG vrd, OP_REG vrb));
		ADD_OPCODE(VRLB,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VRLH,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VRLW,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VRSQRTEFP,(OP_REG vrd, OP_REG vrb));
		ADD_OPCODE(VSEL,(OP_REG vrd, OP_REG vra, OP_REG vrb, OP_REG vrc));
		ADD_OPCODE(VSL,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VSLB,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VSLDOI,(OP_REG vrd, OP_REG vra, OP_REG vrb, OP_uIMM sh));
		ADD_OPCODE(VSLH,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VSLO,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VSLW,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VSPLTB,(OP_REG vrd, OP_uIMM uimm5, OP_REG vrb));
		ADD_OPCODE(VSPLTH,(OP_REG vrd, OP_uIMM uimm5, OP_REG vrb));
		ADD_OPCODE(VSPLTISB,(OP_REG vrd, OP_sIMM simm5));
		ADD_OPCODE(VSPLTISH,(OP_REG vrd, OP_sIMM simm5));
		ADD_OPCODE(VSPLTISW,(OP_REG vrd, OP_sIMM simm5));
		ADD_OPCODE(VSPLTW,(OP_REG vrd, OP_uIMM uimm5, OP_REG vrb));
		ADD_OPCODE(VSR,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VSRAB,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VSRAH,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VSRAW,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VSRB,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VSRH,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VSRO,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VSRW,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VSUBCUW,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VSUBFP,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VSUBSBS,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VSUBSHS,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VSUBSWS,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VSUBUBM,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VSUBUBS,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VSUBUHM,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VSUBUHS,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VSUBUWM,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VSUBUWS,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VSUMSWS,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VSUM2SWS,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VSUM4SBS,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VSUM4SHS,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VSUM4UBS,(OP_REG vrd, OP_REG vra, OP_REG vrb));
		ADD_OPCODE(VUPKHPX,(OP_REG vrd, OP_REG vrb));
		ADD_OPCODE(VUPKHSB,(OP_REG vrd, OP_REG vrb));
		ADD_OPCODE(VUPKHSH,(OP_REG vrd, OP_REG vrb));
		ADD_OPCODE(VUPKLPX,(OP_REG vrd, OP_REG vrb));
		ADD_OPCODE(VUPKLSB,(OP_REG vrd, OP_REG vrb));
		ADD_OPCODE(VUPKLSH,(OP_REG vrd, OP_REG vrb));
